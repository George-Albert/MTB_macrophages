...
{ 
  ...
  pdf(file.path(cluster_dir,"006_Explained_variance.pdf"),width=9,height=6)
  print(var_plt)
  dev.off()
  ...
  pdf(file.path(cluster_dir,"007_Explained_variance_BIC.pdf"),width=9,height=6)
  print(bic_plt)
  dev.off()
...
### Save the data
filename <- file.path(cluster_dir,paste0("008_Heatmap_clustering_2_normalized_k=",k,".pdf"))
