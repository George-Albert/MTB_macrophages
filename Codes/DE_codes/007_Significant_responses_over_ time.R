...
writeLines(list_DE_infected_overtime[[1]], file.path(cluster_input_dir,paste0(file_name[1],".txt")))
writeLines(list_DE_infected_overtime[[2]], file.path(cluster_input_dir,paste0(file_name[2],".txt")))
writeLines(list_DE_infected_overtime[[3]], file.path(cluster_input_dir,paste0(file_name[3],".txt")))
writeLines(list_DE_infected_overtime[[4]], file.path(cluster_input_dir,paste0(file_name[4],".txt")))
