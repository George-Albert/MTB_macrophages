...
script_id  <- "005_1Setting_data_annotation"
...

{
  ...
  # Obtain information about the gene type
  ...
  length(unique(gene_types_bp$SYMBOL))
  # 18018
  ...
  # Time difference of 5.80801 secs
  ...
  # Time difference of 2.834607 secs
  ...
  # Time difference of 0.9895949 secs
