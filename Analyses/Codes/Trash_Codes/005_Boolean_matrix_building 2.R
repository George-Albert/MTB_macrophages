...
####We are going to use the gene2ensemble file form clueGO to assure the match 
#### in the annotation scheme
# trans_gene_id <- human_ncbi
trans_gene_id <- gene2ensemble
colnames(trans_gene_id)[1] <- "NCBI.GeneID"
...
if (!is.character(trans_gene_id$NCBI.GeneID)) {
  print(class(trans_gene_id$NCBI.GeneID))
  trans_gene_id$NCBI.GeneID <- as.character(trans_gene_id$NCBI.GeneID)
  print("The vector have been transformed to a character vector")
}else{print("The vector is already a character vector")}
