...
write.table(hclust_df,file = file.path(input_folder,paste0("Cluster_by_stage_sortby_OR_p_value_",list_name,".txt")))

dir.create(file.path(output_dir,"001_Figures","005_Enrichment",config_dir),recursive=T,showWarnings =F)
filename <- file.path(output_dir,"001_Figures","005_Enrichment",config_dir,paste0("Heatmap_GO_by_stage_",list_name,".pdf"))
